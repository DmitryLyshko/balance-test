...
<div class="costclient">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($model, 'date_from')->widget('trntv\yii\datetime\DateTimeWidget', [])->label('Дата начала') ?>
        <?= $form->field($model, 'date_to')->widget('trntv\yii\datetime\DateTimeWidget', [])->label('Дата завершения') ?>
